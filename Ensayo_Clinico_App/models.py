...
class ExamenLabClinico(models.Model):
    ...
    linfocitos_valor = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True)
    linfocitos = models.SmallIntegerField(blank=True, null=True)
    monocitos_valor = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True)
    monocitos = models.SmallIntegerField(blank=True, null=True)
    basofilos_valor = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True)
    eosinofilos = models.SmallIntegerField(blank=True, null=True)
    eosinofilos_valor = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True)
    basofilos = models.SmallIntegerField(blank=True, null=True)
    c_plaquetas_valor = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True)
    c_plaquetas = models.SmallIntegerField(blank=True, null=True)
    eritro_valor = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True)
